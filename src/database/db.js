...
// Funkcja migracji tabeli kuriers - dodaje brakujące kolumny
const migrateKuriersTable = async () => {
  try {
    ...
    if (!tableExists) {
      console.log('❌ Tabela kuriers nie istnieje - pomijam migrację');
      return;
    }
    ...
    const columnNames = columns.rows.map(row => row.column_name);
    console.log('🔍 Aktualne kolumny w tabeli kuriers:', columnNames);

    // Dodaj brakujące kolumny dla odbiorcy
    if (!columnNames.includes('recipient_street')) {
      await db.schema.table('kuriers', table => {
        table.string('recipient_street');
      });
      console.log('✅ Dodano kolumnę recipient_street');
    }
    ...
    if (!columnNames.includes('recipient_city')) {
      ...
      console.log('✅ Dodano kolumnę recipient_city');
    }
    ...
    if (!columnNames.includes('recipient_postcode')) {
      ...
      console.log('✅ Dodano kolumnę recipient_postcode');
    }
    ...
    if (!columnNames.includes('recipient_email')) {
      ...
      console.log('✅ Dodano kolumnę recipient_email');
    }
    ...
    if (!columnNames.includes('recipient_company')) {
      ...
      console.log('✅ Dodano kolumnę recipient_company');
    }
    ...
    if (!columnNames.includes('package_weight')) {
      ...
      console.log('✅ Dodano kolumnę package_weight');
    }
    ...
    if (!columnNames.includes('package_length')) {
      ...
      console.log('✅ Dodano kolumnę package_length');
    }
    ...
    if (!columnNames.includes('package_width')) {
      ...
      console.log('✅ Dodano kolumnę package_width');
    }
    ...
    if (!columnNames.includes('package_height')) {
      ...
      console.log('✅ Dodano kolumnę package_height');
    }
    ...
    if (!columnNames.includes('package_type')) {
      ...
      console.log('✅ Dodano kolumnę package_type');
    }
    ...
    if (!columnNames.includes('package_contents')) {
      ...
      console.log('✅ Dodano kolumnę package_contents');
    }
    ...
    if (!columnNames.includes('package_value')) {
      ...
      console.log('✅ Dodano kolumnę package_value');
    }

    // Dodaj kolumny dla usług
    if (!columnNames.includes('service_type')) {
      await db.schema.table('kuriers', table => {
        table.string('service_type').defaultTo('domestic');
      });
      console.log('✅ Dodano kolumnę service_type');
    }
    ...
    if (!columnNames.includes('pickup_date')) {
      ...
      console.log('✅ Dodano kolumnę pickup_date');
    }
    ...
    if (!columnNames.includes('pickup_time_from')) {
      ...
      console.log('✅ Dodano kolumnę pickup_time_from');
    }
    ...
    if (!columnNames.includes('pickup_time_to')) {
      ...
      console.log('✅ Dodano kolumnę pickup_time_to');
    }

    // Dodaj kolumny dla opłat
    if (!columnNames.includes('cod_amount')) {
      await db.schema.table('kuriers', table => {
        table.decimal('cod_amount', 10, 2);
      });
      console.log('✅ Dodano kolumnę cod_amount');
    }
    ...
    if (!columnNames.includes('insurance_amount')) {
      ...
      console.log('✅ Dodano kolumnę insurance_amount');
    }
    ...
    if (!columnNames.includes('saturday_delivery')) {
      ...
      console.log('✅ Dodano kolumnę saturday_delivery');
    }
    ...
    if (!columnNames.includes('return_service')) {
      ...
      console.log('✅ Dodano kolumnę return_service');
    }

    // Dodaj brakujące kolumny systemowe
    if (!columnNames.includes('updated_at')) {
      await db.schema.table('kuriers', table => {
        table.timestamp('updated_at').defaultTo(db.fn.now());
      });
      console.log('✅ Dodano kolumnę updated_at');
    }
    ...
    if (!columnNames.includes('created_by_name')) {
      ...
      console.log('✅ Dodano kolumnę created_by_name');
    }

    // Dodaj kolumnę dla numerów przesyłek DHL (jako string, nie integer)
    if (!columnNames.includes('dhl_shipment_id')) {
      await db.schema.table('kuriers', table => {
        table.string('dhl_shipment_id');
      });
      console.log('✅ Dodano kolumnę dhl_shipment_id');
    }

    // Dodaj kolumnę dla statusu DHL
    if (!columnNames.includes('dhl_status')) {
      await db.schema.table('kuriers', table => {
        table.string('dhl_status');
      });
      console.log('✅ Dodano kolumnę dhl_status');
    }

    // Dodaj kolumnę dla odpowiedzi DHL (JSON)
    if (!columnNames.includes('dhl_response')) {
      await db.schema.table('kuriers', table => {
        table.text('dhl_response');
      });
      console.log('✅ Dodano kolumnę dhl_response');
    }

    console.log('🎉 Migracja tabeli kuriers zakończona pomyślnie!');
